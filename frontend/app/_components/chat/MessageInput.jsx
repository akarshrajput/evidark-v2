...
export default function MessageInput({ onSendMessage, socket, chatId }) {
  ...
  return (
    <div className="space-y-3">
      {/* Main input area */}
      <div className="flex items-center space-x-3 p-3 bg-gray-900/30 rounded-xl backdrop-blur-sm">
        {/* Message input */}
        ...
        <Button
          ...
          size="sm"
          className="bg-red-600 hover:bg-red-700 text-white disabled:bg-gray-700 disabled:text-gray-400 transition-all duration-200 rounded-lg px-4"
        >
